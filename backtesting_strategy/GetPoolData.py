...
def get_swap_data(contract_address,file_name,DOWNLOAD_DATA,network='mainnet'):       
    """
...
def get_liquidity_flipside(flipside_query,file_name,DOWNLOAD_DATA):
    """
...
def get_pool_data_flipside(contract_address,flipside_query,file_name,DOWNLOAD_DATA):
    """
