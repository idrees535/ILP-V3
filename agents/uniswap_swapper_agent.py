...
class UniswapV3SwapperAgent():
    def __init__(self,initial_token0,initial_token1,pool):
        ...
        self.pool=pool
        # self._token0=initial_token0
        # self._token1=intitail_token1
    ...
    def takeStep(self,swap_action, amount, block_time):
        ...
        print(f"____Swap amount:   {amount} fromBase18: {fromBase18(amount)} \n")
        ...
        elif swap_action == 'swap_token1_for_token0':
            tx_receipt=self.pool.swap_token1_for_token0(WALLET_SWAPPER.address, amount, data=b'')
            #print(tx_receipt.events)
            #log_event_to_csv(tx_receipt)
