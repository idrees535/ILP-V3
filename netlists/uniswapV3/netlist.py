...
class SimState(SimStateBase):
    def __init__(self, ss: SimStrategy, pool):
        ...
        self.retail_lp = UniswapV3LiquidityProviderAgent("retail_lp",1e10,1e10,retail_lp_policy,self.pool)
        ...
        # Trader agents
        self.noise_trader = UniswapV3SwapperAgent("noise_trader",1e10,1e10, noise_trader_policy,self.pool)
